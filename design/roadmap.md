...
> (#3/#24/#27/#28/#30) validated — bugs.md round tables. Round 3 filed
> BUG-031 (latent speed×swing composition; behavior pinned by test, fix is
> a deliberate ADR-030 decision). Remaining audit items gated on the
> ADR-033 interactive harness. Sequence below unchanged.)
