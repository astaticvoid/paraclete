...
impl DelayNode {
    ...
    fn default_doc() -> CapabilityDocument {
        CapabilityDocument {
            ...
            params: vec![
                ParamDescriptor { id: PARAM_DELAY_TIME, name: "delay_time_ms".into(), min: 1.0,   max: 2000.0, default: 250.0,  stepped: false, in_kit: true,  unit: ParamUnit::Seconds, display: None },
                ParamDescriptor { id: PARAM_FEEDBACK,   name: "feedback".into(),      min: 0.0,   max: 0.95,   default: 0.4,    stepped: false, in_kit: true,  unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: PARAM_WET,        name: "wet".into(),           min: 0.0,   max: 1.0,    default: 0.5,    stepped: false, in_kit: true,  unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: PARAM_DRY,        name: "dry".into(),           min: 0.0,   max: 1.0,    default: 1.0,    stepped: false, in_kit: true,  unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: PARAM_FILTER_HZ,  name: "filter_hz".into(),     min: 200.0, max: 8000.0, default: 4000.0, stepped: false, in_kit: true,  unit: ParamUnit::Hz,      display: None },
            ],
