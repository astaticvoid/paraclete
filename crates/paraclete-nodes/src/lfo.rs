...
impl LfoNode {
    ...
    fn default_doc() -> CapabilityDocument {
        CapabilityDocument {
            ...
            ports: vec![],
            params: vec![
                ParamDescriptor { id: lp("lfo_waveform"), name: "lfo_waveform".into(), min: 0.0, max: 4.0, default: 0.0, stepped: true,  in_kit: false, unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: lp("lfo_rate"),     name: "lfo_rate".into(),     min: 0.01, max: 20.0, default: 1.0, stepped: false, in_kit: false, unit: ParamUnit::Hz,      display: None },
                ParamDescriptor { id: lp("lfo_depth"),    name: "lfo_depth".into(),    min: 0.0,  max: 1.0,  default: 1.0, stepped: false, in_kit: false, unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: lp("lfo_phase"),    name: "lfo_phase".into(),    min: 0.0,  max: 1.0,  default: 0.0, stepped: false, in_kit: false, unit: ParamUnit::Generic, display: None },
            ],
            extensions: vec![],
    view: None,
        }
...
impl Node for LfoNode {
    ...
    // on the audio thread — no concurrent access to self.phase.
