...
impl OscillatorNode {
    ...
    fn default_doc() -> CapabilityDocument {
        CapabilityDocument {
            ...
            ports: vec![],
            params: vec![
                ParamDescriptor { id: osc_param("waveform"), name: "waveform".into(), min: 0.0, max: 4.0, default: 0.0, stepped: true,  in_kit: true, unit: ParamUnit::Generic,  display: None },
                ParamDescriptor { id: osc_param("pitch"),    name: "pitch".into(),    min: -60.0, max: 60.0, default: 0.0, stepped: false, in_kit: true, unit: ParamUnit::Semitones, display: None },
                ParamDescriptor { id: osc_param("tune"),     name: "tune".into(),     min: -100.0, max: 100.0, default: 0.0, stepped: false, in_kit: true, unit: ParamUnit::Cents, display: None },
                ParamDescriptor { id: osc_param("level"),    name: "level".into(),    min: 0.0, max: 2.0, default: 1.0, stepped: false, in_kit: true, unit: ParamUnit::Generic, display: None },
            ],
            extensions: vec![],
    view: None,
        }
