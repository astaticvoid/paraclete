...
impl ReverbNode {
    ...
    fn default_doc() -> CapabilityDocument {
        CapabilityDocument {
            ...
            params: vec![
                ParamDescriptor { id: PARAM_ROOM_SIZE, name: "room_size".into(),    min: 0.0, max: 1.0,   default: 0.5, stepped: false, in_kit: true, unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: PARAM_DAMPING,   name: "damping".into(),      min: 0.0, max: 1.0,   default: 0.5, stepped: false, in_kit: true, unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: PARAM_WET,       name: "wet".into(),          min: 0.0, max: 1.0,   default: 0.3, stepped: false, in_kit: true, unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: PARAM_DRY,       name: "dry".into(),          min: 0.0, max: 1.0,   default: 0.7, stepped: false, in_kit: true, unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: PARAM_WIDTH,     name: "width".into(),        min: 0.0, max: 1.0,   default: 1.0, stepped: false, in_kit: true, unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: PARAM_PRE_DELAY, name: "pre_delay_ms".into(), min: 0.0, max: 100.0, default: 0.0, stepped: false, in_kit: true, unit: ParamUnit::Generic, display: None },
            ],
