...
impl EnvelopeNode {
    ...
    fn default_doc() -> CapabilityDocument {
        CapabilityDocument {
            ...
            ports: vec![],
            params: vec![
                ParamDescriptor { id: ep("env_mode"), name: "env_mode".into(), min: 0.0, max: 2.0, default: 0.0, stepped: true,  in_kit: true, unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: ep("attack"),   name: "attack".into(),   min: 0.001, max: 4.0, default: 0.01,  stepped: false, in_kit: true, unit: ParamUnit::Seconds, display: None },
                ParamDescriptor { id: ep("decay"),    name: "decay".into(),    min: 0.001, max: 8.0, default: 0.3,   stepped: false, in_kit: true, unit: ParamUnit::Seconds, display: None },
                ParamDescriptor { id: ep("sustain"),  name: "sustain".into(),  min: 0.0,   max: 1.0, default: 0.7,   stepped: false, in_kit: true, unit: ParamUnit::Generic, display: None },
                ParamDescriptor { id: ep("release"),  name: "release".into(),  min: 0.001, max: 8.0, default: 0.5,   stepped: false, in_kit: true, unit: ParamUnit::Seconds, display: None },
            ],
            extensions: vec![],
    view: None,
        }
