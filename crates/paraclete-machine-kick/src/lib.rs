...
//! Paraclete Kick Machine — CLAP instrument (AnalogEngine::kick + Sequencer).
//!
//! Build with: cargo build -p paraclete-machine-kick
//! Output: target/debug/libparaclete_machine_kick.dylib (rename to .clap)
...
unsafe extern "C" fn factory_create_plugin(
    ...
    let inner = SubgraphPlugin::new(Box::new(AnalogEngine::kick()), 3, 48000.0, 512);
